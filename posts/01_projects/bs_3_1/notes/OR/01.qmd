...
basic = np.array([6, 7]) - 1
non_basic = np.array([1, 2, 3, 4, 5]) - 1
...
model.setObjective(5 * x1 + 8 * x2 + 7 * x3 + 4 * x4 + 6 * x5, GRB.MAXIMIZE)

model.addConstr(2 * x1 + 3 * x2 + 3 * x3 + 2 * x4 + 2 * x5 <= 20)
model.addConstr(3 * x1 + 5 * x2 + 4 * x3 + 2 * x4 + 4 * x5 <= 30)
