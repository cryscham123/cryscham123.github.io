...
![Github Kanban Board](img/2025-01-16-19-36-12.png)
...
title: "[DISCUSSION]"
labels: ["enhancement"]
projects: ["organization-for-practice/5"]
body:
  - type: markdown
    attributes:
      value: |
...
![빨간 밑줄 부분을 설정해줍니다.](img/2025-01-16-19-44-52.png)

Kanban board의 Ready section에 있는 작업을 클릭해서 들어간 후, **assignees를 본인으로 선택해서 작업**하면 됩니다.
실제 프로젝트를 진행할 때는 사진처럼 완료된 작업이 아닌 Ready에 있는 작업에 대해 설정합니다.
...
![자동 생성된 branch](img/2025-01-16-19-58-01.png)

이름도 자동으로 생성되게 해서 **convention을 지켜야 한다는 부담을 줄여**줬습니다.

**3. 작업이 완료되면, 모든 조건을 충족하는지 확인한 후, master에 merge 한다.**

![pull request 화면. 사진 속 private key는 딱히 중요하진 않습니다.](img/2025-01-16-20-03-32.png)

작업이 완료됬다고 판단되면 위 화면과 같이 **pull request를 생성**하고, **Reviewer를 설정**해주면 됩니다.

![task completion criteria](img/2025-01-16-20-04-16.png)
