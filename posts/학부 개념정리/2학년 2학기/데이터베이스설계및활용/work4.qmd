...
- ORDERING_ITEM은 부모 테이블 ORDERING과 INGREDIENT가 있어야 하므로 weak entity
- ORDERING, INGREDIENT는 각각 고유한 PK를 가지므로 strong entity
- ORDERING→ORDERING_ITEM: 하나의 ORDERING은 하나의 ORDERING_ITEM에 의존하며, ORDERING_ITEM은 하나 이상의 ORDERING에 연결될 수 있다.
- ORDERING_ITEM←INGREDIENT: 하나의 INGREDIENT는 하나의 ORDERING_ITEM에 의존하며, ORDERING_ITEM은 하나의 ORDERING에 연결된다.
...
- RECIPE_INGREDIENT는 부모 테이블 REIPE와 INGREDIENT가 있어야 하므로 weak entity
- RECIPE, INGREDIENT는 각각 고유한 PK를 가지므로 strong entity
- RECIPE→RECIPE_INGREDIENT: 하나의 RECIPE_INGREDIENT는 반드시 하나의 RECIPE에 의존하며, 하나의 RECIPE는 하나 이상의 RECIPE_INGREDIENT에 연결된다.
- RECIPE_INGREDIENT←INGREDIENT: 하나의 RECIPE_INGREDIENT는 반드시 하나의 INGREDIENT에 의존하며, 하나의 INGREDIENT는 여러 RECIPE_INGREDIENT에 연결될 수도, 안될 수도 있다.

**INGREDIENT - STOCK**

- STOCK은 반드시 하나의 INGREDIENT에 의존하며, 하나의 INGREDIENT는 여러 STOCK과 연결될 수도, 안될 수도 있다.
